...
import { getSourceHandlePosition, getTargetHandlePosition, layoutOptions } from "./utils";
...
function useAutoLayout() {
  ...
  useEffect(() => {
    ...
    const runLayout = () => {
      ...
      const { nodes: nextNodes, edges: nextEdges } = columnarLayout(
        // fixme: ignore this last options
        nodes,
        edges,
        layoutOptions,
      );
      ...
      for (const node of nextNodes) {
        ...
        node.sourcePosition = getSourceHandlePosition(layoutOptions.direction);
        node.targetPosition = getTargetHandlePosition(layoutOptions.direction);
      }
